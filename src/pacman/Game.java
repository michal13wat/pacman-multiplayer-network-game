...
public class Game
{
    ...
    public void init(){
        ...
        numberOfGhost = new IntWrapper(2);
    ...
    public void gotoMenu(String which){
        switch (which){
            case "stage_select":{
                ...
                startMenu.addSpinnerOption("Pacman:0, Ghost:1", null, isPacmanPlayed, 0, 1);
                
                startMenu.addSpinnerOption("Number of ghosts", null, numberOfGhost, 1, 4);
    ...
    public boolean isPacmanPlayed(){
        return isPacmanPlayed.value == 0 ? true : false;
    }
